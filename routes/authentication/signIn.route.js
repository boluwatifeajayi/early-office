...
const { studentSignInSchema } = require("../../middlewares/validation/validation.Schema/authentication/signIn.schema");
...
route.post("/api/student/signIn", validation(studentSignInSchema), studentSignIn);
